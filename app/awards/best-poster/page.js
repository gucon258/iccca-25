      ...
      <div className="flex flex-col items-center justify-center min-h-[50vh] text-center">
        ...
        <div className="bg-white p-10 rounded-xl shadow-lg w-full max-w-2xl">
          ...
          <p className="text-gray-600 text-lg mb-6">
            Information about the Best Poster Award selection process and eligibility requirements will be published soon.
            Please check back later for complete details about this recognition opportunity.
          </p>
...
export default BestPosterAwardPage;