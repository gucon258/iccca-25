...
const ConferenceSchedule = () => {
  ...
  const inaugurationSchedule = [
    ...
    { no: 15, event: "MOU Ceremony: Galgotias University & CCRI, Asia University, Taiwan", time: "11:05 AM" },
    { no: 16, event: "Address by Guest of Honour: Prof. Brij B. Gupta, Director, CCRI, Asia University, Taiwan", time: "11:10 AM" },
