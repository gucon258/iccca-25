...
const Navbar = () => {
  ...
  return (
    <nav className="bg-gradient-to-r from-[#A43AA3] to-[#EE8A37] sticky top-0 z-50 w-full px-4 py-3 md:flex md:items-center md:justify-around">
      ...
      >
        <ul className="flex flex-col md:flex-row gap-4 md:gap-10 text-right md:text-center">
          ...
          <li><a href="https://www.google.com" className="hover:text-gray-200">Committee</a></li>
          <Link href="/guidelines"><li className="hover:text-gray-200">Guidelines</li></Link>
          <Link href="/iccasai23"><li className="hover:text-gray-200">ICCSAI-2023</li></Link>
        </ul>
      </div>
